...
CREATE TABLE `cliente` (
  ...
  `tipoDocumento` varchar(245) DEFAULT NULL,
  ...
  KEY `sexo_idx` (`sexo2`),
  CONSTRAINT `sexo2` FOREIGN KEY (`sexo2`) REFERENCES `sexo` (`idsexo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `detalle_factura_compra` VALUES (6,4,3,5,0,0),(7,3,2,4,0,0),(8,1,4,3,0,0),(9,2,5,5,0,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=7778 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `producto` VALUES (1,'teclado','geymer',2,NULL,2000000,1),(2,'cpu','lg',3,NULL,3000000,1),(3,'maus','calble',4,NULL,5000000,1),(4,'audifonos','inalambrico',2,NULL,3000000,1),(5,'portatil','kalley',5,NULL,2000000,1);
...
INSERT INTO `producto_factura` VALUES (2210,3,4632,2,0.5,'9500000',1),(2211,4,8765,2,0.3,'5820000',1),(2231,1,1231,4,0.5,'3800000',1),(3342,2,1231,3,0.4,'25000000',1),(3452,1,4632,2,0.3,'19400000',1),(4421,3,6576,2,0.2,'9800000',1),(5521,4,8765,1,0.6,'2820000',1),(8934,2,1231,2,0.6,'16920000',1),(9333,2,6576,2,0.9,'16380000',1);
...
CREATE TABLE `provedor` (
  ...
  `sexo1` int NOT NULL,
  `direccion` varchar(45) NOT NULL,
  `condiccion` tinyint NOT NULL,
  PRIMARY KEY (`idprovedor`),
  KEY `sexo_idx` (`sexo1`),
  KEY `tipo_persona_idx` (`tipoPersona`),
  CONSTRAINT `sexo1` FOREIGN KEY (`sexo1`) REFERENCES `sexo` (`idsexo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tipo_persona` FOREIGN KEY (`tipoPersona`) REFERENCES `tipo_provedor` (`idtipo_provedor`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `tipo_provedor` (
  `idtipo_provedor` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(245) NOT NULL,
  PRIMARY KEY (`idtipo_provedor`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tipo_provedor` VALUES (1,'Natural'),(2,'Juridica');
...
INSERT INTO `usuario` VALUES (123,'','edwar','332422444','@','22-22-22',1,'2023-01-22',1,'321','321',1),(1001,'','carlos','2332','sena@','centro',2,'2002-03-02',1,'123','123',1),(121313,'','edw','1233567','edw@','lass',1,'2022-02-02',1,'4444','4444',1),(2323232,'','edw','1232322123','edw@','12-21-21',1,'2023-08-09',1,'1212','1212',1),(12233455,'','EDW','23455678','edw@','centro',1,'2023-01-12',1,'1212','1212',1);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Atualizar_Usuario`(in valor int)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `clic` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `clic`(in nom varchar(250),in tel int,in corre varchar(100),in sex int,fech date,in direc varchar(45))
BEGIN
insert into cliente  value (nom,tel,corre,sex,fech,direc);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
select * from mostrar_cliente where idusuario like concat('%',valor,'%')   
|| Tipodocumento like concat('%',valor,'%') || nombre like concat('%',valor,'%') 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `consul_cliente1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `consul_cliente1`(in valor varchar (45))
BEGIN
select * from mostrar_cliente where idusuario like concat('%',valor,'%')   
|| Tipodocumento like concat('%',valor,'%') || nombre like concat('%',valor,'%') 
|| telefono like concat('%',valor,'%') || correo  like concat('%',valor,'%')
...
BEGIN
select * from mostrar_provedor where idusuario like concat('%',valor,'%') || nit like concat('%',valor,'%')   
|| nombre like concat('%',valor,'%') || cedula like concat('%',valor,'%') 
|| tipoPersona like concat('%',valor,'%') || telefono  like concat('%',valor,'%')
...
BEGIN
select * from mostrar_usuario1 where idusuario like concat('%',valor,'%')   
|| Tipodocumento like concat('%',valor,'%') || nombre like concat('%',valor,'%') 
|| telefono like concat('%',valor,'%') || correo  like concat('%',valor,'%')
 || direcion like concat('%',valor,'%') || nombre like concat('%',valor,'%') 
 || fecha_nacimiento like concat('%',valor,'%') || nombre like concat('%',valor,'%');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `fac_compra` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `fac_compra`(in id_prove int,in id_usuari int,in ti_pago varchar(245),in des float)
BEGIN
insert into factura_compra value (idfactura_compra,id_prove,id_usuari,ti_pago,des,'0',current_date());
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ins_usuario`(in usu int,in nom varchar(250), in tell varchar(15),in corr varchar(100),in direc varchar(45),in sex int,in fech date,in carg int, in log varchar(100), in contra varchar(45))
BEGIN
insert into usuario (idusuario,nombre,telefono,correo,direcion,sexo,fecha_nacimiento,cargo,login,contrasena,condicion) value (usu,nom,tell,corr,direc,sex,fech,carg,log,contra,'1');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `in_usuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `in_usuario`(in usu int,in nom varchar(250), in tell varchar(15),in corr varchar(100),in direc varchar(45),in sex int,in fech date,in carg int, in log varchar(100), in contra varchar(45))
BEGIN
insert into usuario (idusuario,nombre,telefono,correo,direcion,sexo,fecha_nacimiento,cargo,login,contrasena,condicion) value (usu,nom,tell,corr,direc,sex,fech,carg,log,contra,'1');
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_factura` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_factura`(in id_produc int,in id_fac int,in canti int,in des float,total_ven float)
BEGIN
insert into produc_factura value (idproducto_factura,id_produc,id_fac,canti,des,total_ven,'1');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `´in_provedor´`(in nom varchar(245),in cedu varchar(15), in tipo_per varchar(245),in tell int)
BEGIN
insert into provedor values (nom,cedu,tipo_per,tell,direc,'1',nitt);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mostrar_cliente` AS select `u`.`idcliente` AS `idcliente`,`u`.`tipoDocumento` AS `tipoDocumento`,`u`.`nombre` AS `nombre`,`u`.`telefono` AS `telefono`,`u`.`correo` AS `correo`,`s`.`nombre` AS `sexo`,`u`.`fecha_nacimiento` AS `fecha`,`u`.`direccion` AS `direccion` from ((`cliente` `u` join `tipo_documento` `t` on((`t`.`idTipo_documento` = `u`.`tipoDocumento`))) join `sexo` `s` on((`s`.`idsexo` = `s`.`nombre`))) where (`u`.`condicion` = '1') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mostrar_provedor` AS select `p`.`idprovedor` AS `idprovedor`,`p`.`nit` AS `tipoDocumento`,`p`.`nombre` AS `nombre`,`p`.`cedula` AS `cedula`,`p`.`tipoPersona` AS `tipoPersona`,`p`.`telefono` AS `telefono`,`p`.`fecha_nacimiento` AS `fecha`,`s`.`nombre` AS `sexo`,`p`.`direccion` AS `direccion` from ((`provedor` `p` join `tipo_documento` `t` on((`t`.`idTipo_documento` = `p`.`nit`))) join `sexo` `s` on((`s`.`idsexo` = `s`.`nombre`))) where (`p`.`condiccion` = '1') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mostrar_usuario` AS select `u`.`idusuario` AS `idusuario`,`u`.`tipoDocumento` AS `tipoDocumento`,`u`.`nombre` AS `nombre`,`u`.`telefono` AS `telefono`,`u`.`correo` AS `correo`,`u`.`direcion` AS `direcion`,`s`.`nombre` AS `sexo`,`u`.`fecha_nacimiento` AS `fecha`,`r`.`nombre` AS `rol` from (((`usuario` `u` join `tipo_documento` `t` on((`t`.`idTipo_documento` = `u`.`tipoDocumento`))) join `sexo` `s` on((`s`.`idsexo` = `s`.`nombre`))) join `cargo` `r` on((`r`.`idcargo` = `u`.`nombre`))) where (`u`.`condicion` = '1') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
