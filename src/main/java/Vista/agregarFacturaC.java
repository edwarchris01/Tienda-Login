...
public class agregarFacturaC extends javax.swing.JFrame {
    ...
    /**
     * Creates new form agregarFacturaC
     */
    ...
    private void initComponents() {
        ...
        jTextField3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 255, 0), 2));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agregarFacturaC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agregarFacturaC().setVisible(true);
            }
        });
    }
